...
const TEMPLATE_SEED: readonly TemplateSeed[] = [
  ...
  },
  {
    ...
    category: 'utility',
    status: 'approved',
    header: 'Invoice {{2}} is due',
    body: 'Hi {{1}}, invoice {{2}} for {{3}} is due on {{4}}. You can settle it from your account in a couple of taps.',
    footer: 'Northwind Retail',
    variables: ['first_name', 'invoice_number', 'amount', 'due_date'],
    buttons: ['Pay now', 'View invoice'],
  },
  {
    name: 'welcome_series_01',
    category: 'marketing',
    status: 'approved',
    header: 'Welcome to Northwind',
    body: 'Hi {{1}}, thanks for joining. Here is {{2}}% off your first order — it is yours for the next {{3}} days.',
    footer: 'Reply STOP to opt out',
    variables: ['first_name', 'discount', 'expiry_days'],
  ...
  },
  {
    ...
    status: 'approved',
    header: null,
    body: 'Your Northwind verification code is {{1}}. It expires in {{2}} minutes. Do not share it with anyone.',
    footer: null,
  ...
  },
  {
    ...
    category: 'utility',
    status: 'pending',
    header: 'Your plan renews soon',
    body: 'Hi {{1}}, your {{2}} plan renews on {{3}}. Nothing to do unless you would like to change it.',
    footer: 'Northwind Retail',
    variables: ['first_name', 'plan_name', 'renewal_date'],
    buttons: ['Manage plan'],
  },
  {
    name: 'black_friday_teaser',
    category: 'marketing',
    status: 'pending',
    header: 'Something big is coming',
    body: 'Hi {{1}}, our biggest sale of the year opens {{2}}. Early access for you, {{3}} hours before everyone else.',
    footer: 'Reply STOP to opt out',
    variables: ['first_name', 'launch_date', 'head_start_hours'],
    buttons: ['Remind me'],
  },
  {
    name: 'referral_bonus_blast',
    category: 'marketing',
    status: 'rejected',
    header: 'Earn {{1}} for every friend',
    body: 'Hi {{2}}, refer a friend and you both get {{1}}. Unlimited referrals, no catch, guaranteed payout every time.',
    footer: null,
    variables: ['bonus_amount', 'first_name'],
    buttons: ['Invite a friend'],
  },
  {
    ...
    body: 'Hi {{1}}, your appointment on {{2}} at {{3}} is confirmed. Reply RESCHEDULE if you need a different time.',
    footer: 'Northwind Retail',
    variables: ['first_name', 'date', 'time'],
    buttons: ['Add to calendar', 'Reschedule'],
  },
  {
    name: 'winter_clearance_v1',
    category: 'marketing',
    status: 'paused',
    header: 'Winter clearance',
    body: 'Hi {{1}}, up to {{2}}% off winter stock while it lasts. Sizes are going quickly.',
    footer: 'Reply STOP to opt out',
    variables: ['first_name', 'discount'],
    buttons: ['Shop clearance'],
  },
];
